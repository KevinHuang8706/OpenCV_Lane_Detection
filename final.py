...
a=int(input(": "))
result1=cv2.VideoWriter('result1.mp4',cv2.VideoWriter_fourcc(*'MPEG'),10,(1920,1080))
def crop(img,points):
...
if a==2:
    ...
    result2 = cv2.VideoWriter('result2.mp4', cv2.VideoWriter_fourcc(*'XVID'), 10, (1920, 1080))
    if cap.isOpened() == False:
        print('error loading file')
    while cap.isOpened():
        ret, frame = cap.read()
